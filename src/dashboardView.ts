...
export interface DashboardActions {
  ...
  runTicketStep(ticketId: string): Thenable<void>;
  completeTicketStep(ticketId: string): Thenable<void>;
    ...
    webviewView.webview.onDidReceiveMessage(async (message: unknown) => {
      ...
      switch (payload.type) {
        case "createTicket":
          ...
          return;
        case "runTicketStep":
          if (payload.ticketId) await this.actions.runTicketStep(payload.ticketId);
          return;
        case "completeTicketStep":
          if (payload.ticketId) await this.actions.completeTicketStep(payload.ticketId);
          return;
        case "configureUsage":
